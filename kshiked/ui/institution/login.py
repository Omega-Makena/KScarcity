...
def render_landing_page():
    ...
    with center_col:
        # WHAT
        st.markdown(
            '''<div style="background:#F8FAFC; border-radius:8px; padding:20px; border-left:4px solid #BB0000; margin-bottom: 1rem; box-shadow:0 4px 6px rgba(0,0,0,0.05);">
        ...
        # WHY
        st.markdown(
            '''<div style="background:#F8FAFC; border-radius:8px; padding:20px; border-left:4px solid #F59E0B; margin-bottom: 1rem; box-shadow:0 4px 6px rgba(0,0,0,0.05);">
        ...
        # WHERE
        st.markdown(
            '''<div style="background:#F8FAFC; border-radius:8px; padding:20px; border-left:4px solid #3B82F6; margin-bottom: 1rem; box-shadow:0 4px 6px rgba(0,0,0,0.05);">
        ...
        # HOW
        st.markdown(
            '''<div style="background:#F8FAFC; border-radius:8px; padding:20px; border-left:4px solid #006600; margin-bottom: 1rem; box-shadow:0 4px 6px rgba(0,0,0,0.05);">
        ...
        # WHEN
        st.markdown(
            '''<div style="background:#F8FAFC; border-radius:8px; padding:20px; border-left:4px solid #8B5CF6; margin-bottom: 2rem; box-shadow:0 4px 6px rgba(0,0,0,0.05);">
