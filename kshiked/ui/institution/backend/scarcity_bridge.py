...
# Note: scarcity engine imports are intentionally lazy (inside __init__)
# to avoid eagerly loading PyTorch/Numba at dashboard startup time.
...
class ScarcityBridge:
  ...
  """
  def __init__(self):
    # Lazy import — only load heavy engine when ScarcityBridge is actually used
