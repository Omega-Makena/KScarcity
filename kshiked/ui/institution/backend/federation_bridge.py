...
# Note: scarcity.federation imports are intentionally lazy (inside methods)
# to avoid eagerly loading PyTorch at dashboard startup time.
...
class FederationBridge:
  ...
  def aggregate_spoke_models(payloads: List[Dict[str, Any]], method_name: str = "trimmed_mean") -> Tuple[np.ndarray, dict]:
    ...
    """
    # Lazy import to avoid loading PyTorch at dashboard startup
