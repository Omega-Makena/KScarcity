...
# â”€â”€ Quick-suggestion chips shown under the welcome card â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
_QUICK_SUGGESTIONS = [
  "Finance Bill 2026",
  "SHIF Phase 2",
...
def _inject_chat_css(theme):
  ...
  /* â”€â”€ Quick suggestion chips â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  .chip-row {{
    display: flex;
    flex-wrap: wrap;
    gap: 0.5rem;
...
def _render_chat_history(theme):
  ...
  # First message is the welcome â€” render it as a styled card
  ...
  for idx, msg in enumerate(msgs):
    ...
    # Skip the original welcome text (index 0) â€” we rendered it above
